...
public class MockDSLBuilderWhenTableLike<Q extends Query & TableLike<R>, R extends Record> {
   ...
   */
  public MockDSLBuilderWhenTableLike(final Q query, final MockDSLDataProvider dataProvider, final MockDSLBuilder builder) {
  ...
  public MockDSLBuilder thenReturn(Record... records) {
    dataProvider.addTableLikeQueryResult(query, records);
    return builder;
  }
